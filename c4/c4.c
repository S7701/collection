...
void expr(int lev) {
  ...
  case And:
    ...
    ty = ty + PTR;
    break;
  case '!': next(); expr(Inc); *++e = PUSH; *++e = IMM; *++e = 0; *++e = EQ; ty = INT; break;
  case '~': next(); expr(Inc); *++e = PUSH; *++e = IMM; *++e = -1; *++e = XOR; ty = INT; break;
