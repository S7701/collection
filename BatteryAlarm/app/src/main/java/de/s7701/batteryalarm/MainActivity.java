...
public class MainActivity extends AppCompatActivity {
    ...
    //method for showing battery level alert box
    ...
    private void updateProgressText(int progress) {
        progressValueTextView.setText("Selected Battery Level for Battery Alarm: " + progress + "%");
    }
